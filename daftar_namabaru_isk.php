...
<body>
    ...
    <div class="navbar">
        <a class="daftar" href="daftar_namabaru_isk.php">Daftar Nama Baharu</a>
        <a href="senaraiisk.php">Senarai Nama</a>
...
<?php
    ...
    if(isset($_POST['hantar'])){
        ...
        $add = mysqli_query($connect, "INSERT INTO maklumatisk SET no_angka_giliran='$no_angka_giliran', nama='$nama', no_ic='$no_ic', tarikh_lahir='$tarikh_lahir', warganegara='$warganegara', negeri_kelahiran='$negeri_kelahiran', batch='$batch', sem='$sem'");
    }
?>
</html>
