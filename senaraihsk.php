...
<body>
    ...
    <div class="navbar">
        <a href="daftar_namabaru_hsk.php">Daftar Nama Baharu</a>
        <a class="daftar" href="senaraihsk.php">Senarai Nama</a>
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($papar)){
                        ...
                        <tr>
                            ...
                            <td>".$row['sem']."</td>
                            <td>
                                <a href='padamhsk.php?no_angka_giliran=".$row['no_angka_giliran']."' class='btn-danger'>Padam</a>
                            </td>
                            <td>
                                <a href='updatehsk.php?no_angka_giliran=".$row['no_angka_giliran']."' class='btn-update'>Kemaskini</a>
                            </td>
                        </tr>
                        ";
                    }
